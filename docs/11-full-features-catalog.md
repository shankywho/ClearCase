...
| **9** | **Groq Open-Source Dual Fallback** | `GroqLLMClient` | Groq API (`llama-3.3-70b-versatile`, `qwen-2.5-32b`) | High-speed, cost-effective open-source LLM backup when AWS Bedrock is throttled or offline. |
